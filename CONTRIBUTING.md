...
```
git clone git@github.com:mxochicale/physical-and-embodied-ai-in-healthcare.git
```

## New issues
* Open an issue (bug report, feature request, or something is not working): https://github.com/mxochicale/physical-and-embodied-ai-in-healthcare/issues/new
